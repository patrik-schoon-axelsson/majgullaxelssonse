<template>
  <div class="z-depth-2">
      ...
      <br>
         ...
         <br>
         <br>
         Nu var jag reporter och medlem i Journalistförbundet.
        Norrköping blev mitt universitet, det var där jag verkligen lärde mig yrket. 
        Jag jobbade vidare som journalist i ytterligare 18 – 19 år men kände allt tydligare att journalistiken inte räckte till. 
        Ändå tog jag övergången till skönlitteraturen i små steg. Först skrev jag en ängslig liten fackbok om barnarbete, men tog sedan tjänstledigt och gick vidare med dokumentärromanen <em>Rosario är död</em> 
        som handlar om filippinska barn i sexhandel. Det var en bok som förändrade mitt liv, dels genom att jag för första gången själv var den som bestämde över min tid och därför kunde ägna åtskilligt mycket mer tid åt research än jag någonsin hade gjort, 
        och dels genom att den befriade mitt språk från journalistikens tvångströja. När jag insåg det sa jag upp mig från mitt journalistjobb och skrev min första rent fiktiva roman: <em>Långt borta från Nifelheim</em>. 
        Nu skulle jag bli författare på heltid, även om jag måste frilansa en del för att hålla svälten från dörren. 
        Ett av de frilansjobben blev en reportagebok: <em>… och dom som inte har</em>. Den blev mitt farväl till journalistiken. 
        Därefter satte jag i gång med nästa fiktiva roman. Den hette <em>Aprilhäxan</em> och blev mitt genombrott.
        <br>
